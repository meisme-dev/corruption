...
Game::Game(int height, int width, GLFWwindow* window) :
	...
	texture_handle[1] = texture->create("/Assets/Textures/ball_fire.png", 0, 0, false, 1, bgfx::TextureFormat::RGBA8, flags);
...
void Game::loop() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		float mtx[16];
		bx::mtxSRT(mtx, 0.5f, 0.5f, 0.5f, 0.0f, 0.0f, mvx * 0.5f, mvx * 0.75f, mvy * 0.75f, 0.0f);
